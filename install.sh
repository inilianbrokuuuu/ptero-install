...
display_welcome() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BLUE}[+]            SCRIPT AUTO INSTALLER          [+]${NC}"
  echo -e "${BLUE}[+]                  © BY LIANBOTZ                   [+]${NC}"
  echo -e "${BLUE}[+] ===============================================  [+]${NC}"
  echo -e ""
  echo -e "script ini di buat untuk mempermudah penginstalasian pterodactyle,"
  echo -e "dilarang keras untuk memperjual belikan."
  echo -e ""
  echo -e "JANGAN LUPA SUBSCRIBE @LianBotz⚡"
  echo -e "Base By LianBotz⚡"
  echo -e "Ada Yang Error Chat : 089536585151"
  echo -e "Creator By : LianBotz⚡"
  echo -e "LIANBOTZ"
  sleep 4
  clear
}
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY LIAN HOSTING             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "Lianhosting00" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN} Silahkan Chat Whatsapp Lian Hosting Jika Token Salah.${NC}"
    exit 1
  fi
  clear
}
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
bash <(curl -s https://raw.githubusercontent.com/inilianbrokuuuu/ptero-install/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
while true; do
  ...
  echo -e "                                                       "
  echo -e "${YELLOW}[+]=================================[+]${NC}"
  echo -e "${YELLOW}  MENU INSTALLER BY LIAN HOSTING${NC}"
  echo -e "${YELLOW}     BASE BY: LIAN HOSTING${NC}"
  echo -e "${YELLOW}[+]=================================[+]${NC}"
  echo -e "                                                       "
  echo -e "MENU INSTALLER :"
  echo "1. Install Thema"
  echo "2. Create Node"
  echo "3. Configure Wings"
  echo "4. Uninstall Panel"
  echo "5. Uninstall Thema"
  echo "x. Exit"
